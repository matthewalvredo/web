    ...
    <div id="sidebar-menu" class="sidebar-menu">
      <ul class="sidebar-vertical">
        ...
        <li class="submenu">
          ...
          <ul>
            <li><a class="{{ request()->is('laporanstock') ? 'active' : '' }}" href="laporanstock">Laporan Stock</a></li>
            <li><a class="{{ request()->is('laporancredit') ? 'active' : '' }}" href="laporancredit">Laporan Keuangan</a></li>
          </ul>
        </li>
